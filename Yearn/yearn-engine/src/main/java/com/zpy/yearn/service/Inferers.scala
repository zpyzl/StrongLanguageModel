...
object Inferers {
  ...
  def extract(): Set[TPred] = {
    predExtractors.flatMap(_.extractPreds(机器人的头脑.all()))
  }
  ...
  def runEach2Received(): Unit = {
    val allReceived = 机器人的头脑.received
        ...
        case cause1: Cause =>
          ...
          if (cause1.reasons.size == 1 && cause2.reasons.size == 1 &&
            ...
            if (cause1.credibility == cause2.credibility) {
              ...
              机器人的头脑.questionable += cause1
              机器人的头脑.questionable += cause2
