...
public class ChSentenceService {// extends LabeledScoredTreeNode {
    ...
    public List<TPred> stc2Clause(String sentenceStr, BotContext chatbotContext) throws YearnException {
    ...
    public List<TPred> stc2Clause(String sentences) throws YearnException {
        return stc2Clause(sentences, new PsychoCounselContext() {
            @Override
